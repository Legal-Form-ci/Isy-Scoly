...
export const translations: Record<Language, Translations> = {
  fr: {
    ...
    spaces: {
      ...
      secondary: {
        ...
        description: "Retrouvez toutes vos fournitures scolaires et bureautiques organisées par niveau : Préscolaire, Primaire, Secondaire, Université et Bureau.",
        features: [
  ...
  en: {
    ...
    hero: {
      ...
      subtitle: "ScoOffice+ supports you in your educational journey with quality supplies, delivered free throughout Ivory Coast.",
      cta: "Discover our products",
      demo: "View News",
      secondaryTitle: "ScoOffice+ News",
      secondaryDesc: "School and office news",
      universityTitle: "ScoOffice+ News",
      universityDesc: "School and office news",
      shopTitle: "ScoOffice+ Shop",
      shopDesc: "Books and school supplies",
    },
    spaces: {
      title: "Everything for your academic success",
      subtitle: "ScoOffice+ offers quality products and educational resources to support your journey.",
      secondary: {
        title: "ScoOffice+ Shop",
        description: "Find all your school and office supplies organized by level: Preschool, Primary, Secondary, University and Office.",
        features: [
          "Complete catalog",
          "Competitive prices",
          "Wide range",
    ...
    cta: {
      ...
      subtitle: "Join thousands of customers who have already chosen ScoOffice+ for their supplies.",
  ...
  de: {
    nav: {
      ...
      secondaryDesc: "Schul- und Büronachrichten",
      university: "Nachrichten",
      universityDesc: "Schul- und Büronachrichten",
      easyScolaire: "Shop",
      about: "Über uns",
      contact: "Kontakt",
      login: "Anmelden",
    ...
    hero: {
      ...
      subtitle: "ScoOffice+ begleitet Sie auf Ihrem Bildungsweg mit Qualitätsprodukten, kostenlos geliefert in der gesamten Elfenbeinküste.",
      cta: "Shop entdecken",
      demo: "Nachrichten ansehen",
      secondaryTitle: "ScoOffice+ Nachrichten",
      secondaryDesc: "Schul- und Büronachrichten",
      universityTitle: "ScoOffice+ Nachrichten",
      universityDesc: "Schul- und Büronachrichten",
      shopTitle: "ScoOffice+ Shop",
    ...
    spaces: {
      ...
      subtitle: "ScoOffice+ bietet Qualitätsprodukte für Schul- und Bürobedarf.",
      secondary: {
        title: "ScoOffice+ Boutique",
        description: "Finden Sie alle Ihre Schul- und Büromaterialien nach Stufe geordnet: Vorschule, Grundschule, Sekundarstufe, Universität und Büro.",
        features: [
    ...
    payment: {
      ...
      benefits: ["Sichere und verschlüsselte Transaktionen", "Sofortige SMS-Bestätigung", "Keine versteckten Gebühren", "24/7 Kundensupport"],
      cta: "ScoOffice+ entdecken",
    ...
    cta: {
      ...
      subtitle: "Schließen Sie sich Tausenden von Kunden an, die bereits ScoOffice+ für ihre Einkäufe gewählt haben.",
    ...
    footer: {
      ...
      phone: "+225 07 00 00 00 00", email: "contact@scoofficeplus.ci",
  ...
  es: {
    nav: {
      easyClass: "ScoOffice+",
      secondary: "Noticias",
      secondaryDesc: "Noticias escolares y de oficina",
      university: "Noticias",
      universityDesc: "Noticias escolares y de oficina",
      easyScolaire: "Tienda",
      about: "Acerca de",
      contact: "Contacto",
    ...
    hero: {
      ...
      subtitle: "ScoOffice+ te acompaña en tu camino educativo con materiales de calidad, entregados gratis en toda Costa de Marfil.",
      cta: "Descubrir la tienda",
      demo: "Ver noticias",
      secondaryTitle: "Noticias ScoOffice+",
      secondaryDesc: "Noticias escolares y de oficina",
      universityTitle: "Noticias ScoOffice+",
      universityDesc: "Noticias escolares y de oficina",
      shopTitle: "Tienda ScoOffice+",
      shopDesc: "Libros y materiales escolares",
    },
    spaces: {
      title: "Todo para tu éxito escolar y profesional",
      subtitle: "ScoOffice+ ofrece productos de calidad para tus necesidades escolares y de oficina.",
      secondary: {
        title: "Tienda ScoOffice+",
        description: "Encuentra todos tus materiales escolares y de oficina organizados por nivel: Preescolar, Primaria, Secundaria, Universidad y Oficina.",
        features: ["Catálogo completo", "Precios competitivos", "Amplio catálogo", "Reseñas de clientes"],
        cta: "Ver tienda",
      },
      university: {
        title: "Noticias ScoOffice+",
    ...
    features: {
      title: "¿Por qué elegir ScoOffice+?",
    ...
    payment: {
      ...
      benefits: ["Transacciones seguras y encriptadas", "Confirmación instantánea por SMS", "Sin cargos ocultos", "Soporte al cliente 24/7"],
      cta: "Descubrir ScoOffice+", amountLabel: "Monto a pagar", secure: "Pago 100% seguro",
    },
    ...
    cta: {
      ...
      subtitle: "Únete a miles de clientes que ya han elegido ScoOffice+ para sus compras.",
    ...
    contact: {
      title: "Contáctanos", subtitle: "¿Tienes una pregunta? No dudes en contactarnos",
      name: "Nombre completo", email: "Correo electrónico", subject: "Asunto", message: "Mensaje",
      send: "Enviar", success: "¡Mensaje enviado!",
      successMessage: "Te responderemos lo antes posible.", info: "Nuestra información de contacto",
    },
    about: {
      title: "Acerca de ScoOffice+",
      subtitle: "Nuestra misión es facilitar el acceso a materiales escolares y de oficina",
      mission: "Nuestra misión",
      missionText: "Ofrecer a las familias marfileñas un acceso fácil a materiales escolares y de oficina de calidad con entrega gratuita.",
    ...
    common: {
      ...
      clear: "Borrar", apply: "Aplicar", close: "Cerrar", viewAll: "Ver todo",
      seeMore: "Ver más", learnMore: "Saber más", readMore: "Leer más",
      showLess: "Ver menos", noResults: "Sin resultados", tryAgain: "Intentar de nuevo",
