...
export const translations: Record<Language, Translations> = {
  fr: {
    ...
    footer: {
      ...
      address: "Abidjan, Côte d'Ivoire", phone: "+225 07 59 56 60 87", email: "contact@scoly.ci",
  ...
  en: {
    ...
    payment: {
      ...
      benefits: ["Secure and encrypted transactions", "Instant SMS confirmation", "No hidden fees", "24/7 customer support"],
    ...
    footer: {
      ...
      phone: "+225 07 59 56 60 87", email: "contact@scoly.ci",
